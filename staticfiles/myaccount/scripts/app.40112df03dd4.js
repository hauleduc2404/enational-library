...
// window.addEventListener("load", function(){
//     const slider = document.querySelector(".bbBookList");
//     const sliderMain = document.querySelector(".bbSlick-track");
//     const sliderItems = document.querySelectorAll(".bbSlick-slide");
//     const nextBtn = document.querySelector(".bbSlider-next");
//     nextBtn.style = `cursor:pointer`;
//     const prevBtn = document.querySelector(".bbSlider-prev");
