...
// const placeHoldBtn = document.querySelector(".book-top-borrow");
// const bookLinkTitle = document.querySelector(".bookLinkTitle");
// // placeHoldBtn.addEventListener("onmouseover", function(){
// //     bookLinkTitle.style = `outline: none; box-shadow: none`;
// //     console.log("onemouse");
// // });
// bookLinkTitle.onmouseover = function() {

// }
// placeHoldBtn.onmouseover = function() {
//     bookLinkTitle.style = `outline: none; box-shadow: none`;
//     console.log("onemouse");
// };
